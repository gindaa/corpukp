            ...
            <div class="card-header">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <?php
                // $query = "SELECT k.id_kegiatan,k.nama_kegiatan, k.tanggal, g.nama_gedung, ke.nama, k.keterangan
                //           FROM kegiatan k 
                //           JOIN gedung g ON g.id_gedung=k.id_gedung 
                //           JOIN kelas ke ON ke.id_kelas=k.id_kelas";
                // Rahmat 
