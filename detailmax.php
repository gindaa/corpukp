...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Detail Kelas Paling Sering Digunakan</li>
    </ol>
    <!-- Icon Cards-->
    <div class="card mb-3">
      <div class="card-header">
        ...
        <div class="card-body">
          <div class="table-responsive">
            ...
            WHERE room_count = (SELECT MAX(room_count) FROM classroom)";
            ...
            if (mysqli_num_rows($tampil)>0) {
             ...
             <form method="post" action="#" enctype="multipart/form-data">
              ...
              <label>Kelas
              <input type="text" class="form-control" name="nama_kelas" disabled="" value="<?php echo $data['room_name']; ?>"></label>
            </div>
